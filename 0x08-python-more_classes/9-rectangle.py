...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Args:
            1.rect_1 (obj): rectangle 1
            2.rect_2 (obj): rectangle 2
        Returns:
            1.rect_1: if both rectangles have same value
            2.biggest rectangle
        Raise:
            1.TypeError: if either args are not objects
        '''
    ...
    def square(cls, size=0):
        '''Return a new instance with both sides equal
        Args:
